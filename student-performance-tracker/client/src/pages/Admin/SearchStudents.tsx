					...
					{editingStudent && (
						<div className="bg-yellow-50 border-l-4 border-yellow-400 p-6 rounded-lg shadow mb-6" role="region" aria-label="Edit student form">
							...
							<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
								...
								<input type="number" value={editingStudent.semester} onChange={(e) => setEditingStudent({ ...editingStudent, semester: parseInt(e.target.value) || '' })} className="border px-3 py-2 rounded w-full" placeholder="Semester" aria-label="Edit student semester" min={1} max={8} />
							</div>
