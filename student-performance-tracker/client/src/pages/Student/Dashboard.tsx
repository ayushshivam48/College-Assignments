...
const StudentDashboard = ({ user }: { user?: any }) => {
	...
	return (
		<div className="min-h-screen bg-gray-100 flex">
			<StudentSidebar />
			<main className={`flex-1 ${filteredAnnouncements.length ? "max-w-screen-lg mx-auto" : "w-full"} p-6`}>
				...
				<section className="bg-white rounded-lg shadow p-6 grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-700 mb-6">
				...
				<section className="bg-white rounded-lg shadow p-6 mb-6 inline-block">
